          ...
          <div className={toggleState === 1 ? "qualification__content qualification__content-active" : "qualification__content"}>
            ...
            <div className="qualification__data">
              <div>
                ...
                <span className="qualification__subtitle"> Higher Secondary in<br></br> Barasat P.C.S Government<br></br> High School</span>
                <div className="qualification__calender">
            ...
            <div className="qualification__data">
              ...
              <div>
                <h3 className="qualification__title">Pure Science</h3>
                <span className="qualification__subtitle"> Secondary in<br></br> Barasat P.C.S Government<br></br> High School</span>
                <div className="qualification__calender">
